...
const map_root = "res://roommanager/"


const TARGET_ROOM_COUNT = 15  # Фиксированное количество комнат
const MIN_BOSS_DISTANCE = 5   # Минимальное расстояние от старта до босса
...
func create_branch(start_pos, direction, length):
	...
	for i in range(length):
		...
		# 50% шанс создать боковую ветвь (увеличили вероятность)
...
func place_boss_room():
	...
	# Фильтруем комнаты по минимальному расстоянию
	var candidate_rooms = []
